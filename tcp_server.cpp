...
err_t tcp_server_send_data(void *arg, struct tcp_pcb *tpcb)
{
    ...
    state->sent_len = 0;
    DEBUG_printf("FreakyBob is about to call you. You better pick up!", BUF_SIZE);
...
static bool tcp_server_open(void *arg) {
    ...
    err_t err = tcp_bind(pcb, IP4_ADDR_ANY, TCP_PORT);
    if (err) {
...
/*int main() {
    ...
    if (cyw43_arch_wifi_connect_timeout_ms("One Plus Nord 3 5G", "mc08042003", CYW43_AUTH_WPA2_AES_PSK, 30000)) {
